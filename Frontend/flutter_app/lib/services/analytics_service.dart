  ...
  Future<Map<String, dynamic>?> getViewsPerPost(
    ...
    try {
      ...
      if (response.statusCode == 200) {
        ...
        print('Error fetching ViewsPerPost: ${response.statusCode}');
      }
    } catch (e) {
      print('Exception in getViewsPerPost: $e');
    }
    return null;
  }
  ...
  Future<Map<String, dynamic>?> getVisitorsPerAccount(
    ...
    try {
      ...
      if (response.statusCode == 200) {
        ...
        print('Error fetching VisitorsPerAccount: ${response.statusCode}');
      }
    } catch (e) {
      print('Exception in getVisitorsPerAccount: $e');
    }
    return null;
  }
  ...
  Future<Map<String, dynamic>?> getClickThroughs(
    ...
    try {
      ...
      if (response.statusCode == 200) {
        ...
        print('Error fetching ClickThroughs: ${response.statusCode}');
      }
    } catch (e) {
      print('Exception in getClickThroughs: $e');
    }
    return null;
  }
  ...
  Future<Map<String, dynamic>?> getFollowsByDay(
    ...
    try {
      ...
      if (response.statusCode == 200) {
        ...
        print('Error fetching FollowsByDay: ${response.statusCode}');
      }
    } catch (e) {
      print('Exception in getFollowsByDay: $e');
    }
    return null;
  }
