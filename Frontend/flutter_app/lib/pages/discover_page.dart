  ...
  Widget _buildDiscoverFeed() {
    ...
    return StreamBuilder<List<PostModel>>(
      ...
      builder: (context, postSnapshot) {
        ...
        if (posts.isEmpty) {
          return const Center(child: Text("No other businesses have posted yet."));
        }
        ...
        builder: (context, snapshot) {
          ...
          return ListView.builder(
            ...
            itemBuilder: (context, index) {
              // THE FIX: Convert the search result to a UserModel
              final UserModel business = UserModel.fromFirestore(results[index]);

              return ListTile(
                leading: CircleAvatar(
                  backgroundImage: business.photoUrl != null ? NetworkImage(business.photoUrl!) : null,
                  child: business.photoUrl == null ? const Icon(Icons.store) : null,
                ),
                ...
                onTap: () {
                  ...
                  Navigator.push(
                    context,
                    MaterialPageRoute(
                      builder: (context) => UserProfilePage(userId: business.uid),
                    ),
                  );
                },
              );
