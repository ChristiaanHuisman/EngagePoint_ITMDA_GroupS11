...
cred_path = os.path.join(BASE_DIR, "engagepoint-a2c47-firebase-adminsdk-fbsvc-1c1a597ea3.json")
...
class ReviewModel:
    ...
    def read_all(businessId):
        docs = ReviewModel.collection.where("businessId", "==", businessId).stream()
